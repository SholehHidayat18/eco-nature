...
import DonasiPage from './DonasiPage';
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2">
            <div className="mb-12">
              ...
              <div className="max-w-5xl mx-auto p-4 bg-gray-50 rounded-lg shadow mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button className="px-6 py-2 bg-[#848383] text-white rounded-lg hover:bg-gray-400 text-sm font-medium">
                      <DonasiPage />
                      </button>
                    </div>
                </div>
              ...
              <h2 className="text-3xl font-bold mb-3">Donasi Untuk Penanaman Pohon</h2>

              <p className="text-gray-600 leading-relaxed mb-2">
              Donasi untuk penanaman pohon merupakan solusi yang sangat efektif untuk restorasi lingkungan dan pengendalian iklim. Pohon memiliki peran penting dalam menyerap karbon dioksida (CO2) dari atmosfer, yang membantu mengurangi pemanasan global dan efek rumah kaca. Dengan lebih banyak pohon, jumlah CO2 yang dilepaskan ke atmosfer dapat dikurangi, sehingga membantu memperlambat laju perubahan iklim yang semakin merugikan.
              </p>
              <p className="text-gray-600 leading-relaxed mb-2">
              Penanaman pohon juga memainkan peran penting dalam mencegah erosi tanah dan mengurangi risiko banjir. Selain itu, pohon juga memberikan habitat bagi berbagai spesies flora dan fauna, mendukung keanekaragaman hayati yang sangat penting untuk keseimbangan ekosistem.
              </p>
              <p className="text-gray-600 leading-relaxed mb-2">
              Mari bergabung dalam gerakan ini dengan berdonasi untuk penanaman pohon. Setiap kontribusi yang Anda berikan akan membantu mengendalikan perubahan iklim global dan menciptakan masa depan yang lebih berkelanjutan bagi kita semua.
              </p>
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-7 mt-8">
                ...
                />
                <div>
                    <h2 className="text-2xl font-bold mb-2">Saya Rina Wulandri</h2>
                    <p className="text-gray-600">
                    Hai! Saya adalah jurnalis dan aktivis lingkungan yang fokus pada penanaman pohon. Saya mengedukasi masyarakat tentang pentingnya penanaman pohon untuk mitigasi perubahan iklim dan saya mengajak Anda untuk berdonasi dalam program penghijauan. Mari bersama-sama wujudkan penghijauan bumi.
                    </p>
                </div>
                </div>
              </div>
