        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2">
            <div className="mb-12">
              ...
              <h2 className="text-3xl font-bold mb-3">Donasi untuk Pembangunan Infrastruktur Hijau di Perkotaan</h2>

              <p className="text-gray-600 leading-relaxed mb-2">
              Pembangunan infrastruktur hijau di perkotaan, seperti penanaman pohon dan taman kota, penting untuk mengurangi polusi dan menyediakan ruang terbuka yang mendukung keseimbangan ekosistem. Ruang hijau ini juga memberi tempat bagi masyarakat untuk beraktivitas dan berinteraksi dengan alam.
              </p>
              <p className="text-gray-600 leading-relaxed mb-2">
              Program donasi untuk infrastruktur hijau memungkinkan masyarakat berpartisipasi dalam menciptakan kota yang lebih hijau dan sehat. Kontribusi dana ini mendukung penanaman pohon dan pembuatan taman kota yang bermanfaat bagi lingkungan.
              </p>
              <p className="text-gray-600 leading-relaxed mb-2">
              Dengan dukungan masyarakat, kita bisa menciptakan kota yang ramah lingkungan, berkelanjutan, dan layak huni untuk generasi mendatang.
              </p>
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-7 mt-8">
                ...
                />
                <div>
                    <h2 className="text-2xl font-bold mb-2">Saya Ahmad Fajar</h2>
                    <p className="text-gray-600">
                    Halo! Saya adalah penulis dan ahli perencanaan kota yang fokus pada pembangunan ruang hijau di perkotaan. Saya mendukung proyek penghijauan dan menggalang donasi untuk menciptakan kota yang lebih ramah lingkungan. Mari bergabung dan mulailah berdonasi. 
                    </p>
                </div>
                </div>
              </div>
