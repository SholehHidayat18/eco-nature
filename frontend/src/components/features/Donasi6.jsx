        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2">
            <div className="mb-12">
              ...
              <h2 className="text-3xl font-bold mb-3">Donasi untuk Pelestarian Satwa Liar</h2>

              <p className="text-gray-600 leading-relaxed mb-2">
              Pelestarian satwa liar menjadi tantangan besar karena perburuan ilegal, kehilangan habitat, dan perubahan iklim mengancam banyak spesies. Program pelestarian yang melibatkan masyarakat sangat penting untuk menjaga keberagaman hayati di bumi.
              </p>
              <p className="text-gray-600 leading-relaxed mb-2">
              Program donasi untuk pelestarian satwa liar memberi kesempatan bagi masyarakat untuk berkontribusi dalam melindungi spesies terancam punah, mendanai penyelamatan, rehabilitasi, dan perlindungan habitat mereka. Donasi juga digunakan untuk edukasi konservasi dan tindakan perlindungan satwa liar, menciptakan masa depan yang lebih aman bagi mereka.
              </p>
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-7 mt-8">
                ...
                />
                <div>
                    <h2 className="text-2xl font-bold mb-2">Saya Siti Nurjanah</h2>
                    <p className="text-gray-600">
                    Hai! Saya adalah jurnalis lingkungan yang fokus pada pelestarian satwa liar. Saya mengajak Anda untuk mendonasikan dana bagi organisasi yang melindungi satwa dan habitatnya, serta mendukung rehabilitasi satwa yang diselamatkan. Ayo mulai tunjukkan aksi nyata.
                    </p>
                </div>
                </div>
              </div>
