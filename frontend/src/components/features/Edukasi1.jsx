          ...
          <div className="md:col-span-2">
            <div className="mb-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg flex items-center ml-48 w-[427px] h-[#132px] mb-6">
                ...
                "Kurangi Plastik, Tingkatkan Kehidupan! Setiap Langkah Kecil Membawa Dampak Besar untuk Bumi."
                </blockquote>
              </div>
