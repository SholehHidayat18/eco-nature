        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2">
            <div className="mb-8">
              ...
              />
              <h2 className="text-3xl font-bold mb-3">Dampak Sampah Plastik</h2>
              <p className="text-gray-600 leading-relaxed mb-2">
              Sampah plastik memiliki dampak besar dan terus berkembang menjadi ancaman nyata bagi lingkungan. Plastik yang digunakan hanya dalam hitungan menit bisa bertahan di alam hingga ratusan tahun, sulit terurai, dan kerap berakhir di tempat pembuangan sampah atau mengalir ke sungai dan laut. Di lautan, plastik ini membawa bencana bagi kehidupan laut: penyu, burung, dan ikan bisa terjebak atau salah mengira plastik sebagai makanan, yang pada akhirnya berujung pada kematian mereka. Partikel plastik yang terpecah menjadi mikroplastik juga menyebar ke seluruh ekosistem, mencemari rantai makanan dan pada akhirnya sampai ke tubuh manusia melalui makanan laut dan air yang dikonsumsi sehari-hari.
              </p>
              <p className="text-gray-600 leading-relaxed mb-2">
              Salah satu tantangan utama plastik adalah sifatnya yang sekali pakai. Banyak produk plastik digunakan hanya dalam waktu singkat, tetapi meninggalkan jejak yang sangat lama. Ini menyebabkan timbunan sampah plastik yang menggunung, merusak ekosistem, dan mengancam kehidupan satwa liar. Beberapa jenis plastik bahkan dapat melepaskan zat berbahaya yang masuk ke dalam rantai makanan, memberi dampak buruk pada kesehatan manusia dan makhluk hidup lainnya.
              </p>
              <p className="text-gray-600 leading-relaxed mb-2">
              Meski demikian, solusi untuk mengurangi dampak negatif plastik bukanlah hal yang mustahil. Dengan mengganti plastik sekali pakai dengan alternatif ramah lingkungan, serta mendaur ulang plastik yang sudah ada, kita bisa membantu mengurangi polusi dan menjaga bumi tetap bersih. Penggunaan plastik yang bijak, seperti memilih produk yang dapat digunakan berulang kali atau yang mudah terurai, adalah langkah kecil namun penting yang dapat kita lakukan bersama untuk masa depan yang lebih hijau.
              </p>
            </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg flex items-center ml-48 w-[427px] h-[#132px] mb-6">
                ...
                "Menjaga Alam, Menjaga Kehidupan – Saling Peduli untuk Ekosistem yang Sehat bagi Semua Makhluk Hidup."
                </blockquote>
              </div>
