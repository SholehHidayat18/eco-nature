          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-4 mb-6">
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <div className="ml-2 bg-[#4285F4] text-white px-4 py-1 rounded">
                    DITERIMA
                  </div>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Nama Lengkap : Ramadhan Fikri</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Alamat Email : fikriramadhan@gmail.com</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Nomor Handphone : +62 82255 1810</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Tanggal dan Hari : Selasa, 21/05/2024</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Alamat Lengkap : Jalan Sukajadi, Kelurahan Sukajadi, Kecamatan Sukajadi</span>
                </div>
              </div>

              <div className="border rounded p-4 bg-gray-50">
                <p className="text-gray-700 leading-relaxed">
                Area ini sering dikeluhkan warga karena penumpukan sampah di pinggir jalan yang terkadang belum diangkut tepat waktu. Lokasi ini termasuk area dengan lalu lintas padat dan banyak aktivitas komersial, yang memperparah volume sampah setiap harinya. Masalah ini diperburuk dengan minimnya fasilitas pengelolaan sampah
                </p>
              </div>
            </div>
            ...
            <div className=" mx-auto bg-white">
              <div className="mb-8">
                ...
                <div class="flex justify-center mb-8">
                  <div class="relative">
                    ...
                    class="w-[226px] h-[301px] object-cover rounded-lg" 
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="text-center mb-8">
                <button className="bg-[#3B9E3F] hover:bg-green-700 text-white px-6 py-2 rounded-md transition duration-300 uppercase text-sm font-semibold">
...
export default LaporanPengguna1;