            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Nama Lengkap : Pratama Putra</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Alamat Email : pratamaputra1@gmail.com</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Nomor Handphone : +62 82231 8810</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Tanggal dan Hari : Rabu, 30/10/2024</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Alamat Lengkap : Jalan Kalimantan, Kelurahan Semarang, Kecamatan Sungai Serut, Kota Bengkulu</span>
                </div>
              </div>

              <div className="border rounded p-4 bg-gray-50">
                <p className="text-gray-700 leading-relaxed">
                Jembatan ini berada di area perkotaan yang ramai, menghubungkan beberapa wilayah di Bengkulu dan melintasi Sungai Bengkulu, yang alirannya membawa sampah dari berbagai kawasan di hulu.
                </p>
              </div>
            </div>
...
export default LaporanPengguna2;