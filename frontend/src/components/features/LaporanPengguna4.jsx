            ...
            <div className="space-y-4 mb-6">
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <div className="ml-2 bg-[#FABB05] text-white px-4 py-1 rounded">
                  SEDANG DIPROSES
                  </div>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Nama Lengkap : Putri Alexa</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Alamat Email : putrialexa@gmail.com</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Nomor Handphone : +62 81222 9810</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Tanggal dan Hari : Minggu, 21/07/2024</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Alamat Lengkap : Pasar Pariaman, yang terletak di Jalan Syech Burhanuddin, 
                  Kelurahan Kampung Perak, Kecamatan Pariaman Tengah, Kota Pariaman.</span>
                </div>
              </div>

              <div className="border rounded p-4 bg-gray-50">
                <p className="text-gray-700 leading-relaxed">
                Pasar ini adalah pasar tradisional utama di Kota Pariaman, sehingga aktivitas jual beli yang padat menghasilkan volume sampah yang cukup tinggi setiap harinya. Kondisi ini mengganggu kenyamanan dan kesehatan warga serta pengunjung pasar, terutama pada hari pasar ramai.
                </p>
              </div>
            </div>
...
export default LaporanPengguna4;