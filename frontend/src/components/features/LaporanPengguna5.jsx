            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Nama Lengkap : Chantika Putri</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Alamat Email : putrichantika@gmail.com</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Nomor Handphone : +62 82257 1830</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Tanggal dan Hari : Senin, 21/10/2024</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Alamat Lengkap : Jalan Raya Dieng, tepatnya di kawasan sekitar Kelurahan Tulusrejo, Kecamatan Lowokwaru.</span>
                </div>
              </div>

              <div className="border rounded p-4 bg-gray-50">
                <p className="text-gray-700 leading-relaxed">
                Terdapat tumpukan sampah yang menumpuk di area pembuangan sampah sementara di Jalan Raya Dieng, Malang. Sampah sudah menggunung dan mencemari lingkungan sekitar. Bau menyengat dan kotoran terlihat menyebar di sekitar lokasi, sehingga mengganggu kenyamanan warga setempat.
                </p>
              </div>
            </div>
...
export default LaporanPengguna5;