            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Nama Lengkap : Kefine Putra</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Alamat Email : kefineputraa@gmail.com</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Nomor Handphone : +62 82221 8808</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Tanggal dan Hari : Minggu, 21/01/2024</span>
                </div>
              </div>
              ...
              <div className="border rounded p-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Alamat Lengkap : Terdapat tumpukan sampah di tepi Sungai Batanghari, tepatnya di sekitar Jalan Pahlawan, Kelurahan Pasar Jambi, Kecamatan Jambi Timur, Kota Jambi.</span>
                </div>
              </div>

              <div className="border rounded p-4 bg-gray-50">
                <p className="text-gray-700 leading-relaxed">
                Terdapat tumpukan sampah di tepi Sungai Batanghari, Kota Jambi. Sampah yang menumpuk di sepanjang tepi sungai mencemari lingkungan sekitar dan mengganggu pemandangan. Bau tidak sedap tercium dari sampah yang membusuk, dan kotoran terlihat menyebar di sepanjang sungai, mengancam kualitas air dan kesehatan warga.
                </p>
              </div>
            </div>
...
export default LaporanPengguna6;