    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto p-6">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-[#66BB6A]">Dapatkan Benefitnya</h1>
        </div>
        ...
        <div className="mt-16 mb-10 text-center">
          ...
          <h2 className="text-4xl font-bold text-[#66BB6A] mb-12">Econature Poin?</h2>
          
          <div className="relative">
            
            <div className="grid md:grid-cols-5 gap-8 mb-8">
              <div className="relative">
                <div className="w-16 h-16 bg-[#66BB6A] rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
                  1
                </div>
              ...
              <div className="relative">
                <div className="hidden md:block absolute top-1/2 left-1/4 right-1/4 h-1 bg-[#66BB6A] -translate-y-1/2"></div>
              </div>
